...
// Date Filter - Daily FAE Report
  ...
  // await page.locator('iframe').contentFrame().getByRole('textbox', { name: 'Start date. Available input' }).fill('');
  ...
  // await page.locator('iframe').contentFrame().getByRole('textbox', { name: 'End date. Available input' }).fill('');
...
//Date Filter - Daily FAE Metric
  ...
  // await page.locator('iframe').contentFrame().getByRole('textbox', { name: 'Start date. Available input' }).click();
  // await page.locator('iframe').contentFrame().getByRole('textbox', { name: 'Start date. Available input' }).fill('8/1/2025');
  // await page.locator('iframe').contentFrame().getByRole('textbox', { name: 'End date. Available input' }).click();
  // await page.locator('iframe').contentFrame().getByRole('textbox', { name: 'End date. Available input' }).fill('9/2/2025');
...
//Daily FAE Employee Report
  ...
  // await page.locator('iframe').contentFrame().getByRole('textbox', { name: 'Start date. Available input' }).click();
  // await page.locator('iframe').contentFrame().getByRole('textbox', { name: 'Start date. Available input' }).fill('8/4/2025');
  // await page.locator('iframe').contentFrame().getByRole('textbox', { name: 'End date. Available input' }).click();
  // await page.locator('iframe').contentFrame().getByRole('textbox', { name: 'End date. Available input' }).fill('9/2/2025');
  // await page.locator('iframe').contentFrame().getByText('Press Enter to explore dataBookmark View New').click();
  // await page.waitForTimeout(3000);
